...
<body>
	...
	<div class="container">
				...
				<div class=" col-md-9 contact-left">
					    ...
					    <form action="${basePath}/addAddress.action">
					    	<div>
						    	<span>收货人：</span>
						    ...
						    <div>
						    	<span>联系方式：</span>
						    	<input name="telephone" type="text" class="textbox">
						    </div>
						    <div>
						    	<span>省市区：</span>
						     ...
						     <div>
						    	<span>街道：</span>
						    	<input name="street" type="text" class="textbox">
						    </div>
						      <div>
						    	<span>详细信息：</span>
						    	<input name="fulladdress" type="text" class="textbox">
						    </div>
						   <div>
